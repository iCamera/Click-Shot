...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if(self.present){
        ...
        toViewController.pageIndex = [toViewController.galleryItems indexOfObjectIdenticalTo:cell.galleryItem];
        if (toViewController.pageIndex == NSNotFound) toViewController.pageIndex = 0;
